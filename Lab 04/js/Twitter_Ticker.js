    ...
    success: function (responseData, status) {
      ...
      $.each(responseData, function(i, item) {
        ...
        $(this).attr('src', 'photo.jpg');
         ...
         container1 = $("<div class='ui-grid-solo ui-responsive'><div id = 'dynamictweetDiv' class='ui-block-a'></div></div>");  //dynamic div which is generated for each tweet
        ...
        //code below is to generate hashtags
         ...
         for(var i = 0; i<hash.length; i++){
          ...
          var hashtag = $("<div id ='dynamichashDiv' class='ui-grid-solo ui-responsive'><div style='height:3px'></div></div>");  //dynamic Div to hold one hashtag at at time
